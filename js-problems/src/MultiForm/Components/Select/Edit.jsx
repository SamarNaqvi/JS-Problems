...
function Edit({ value, id, isRequired, isCheckbox = false }) {
  ...
  return (
    <div className="flex">
      <Sorter index={currIndx} />
      <div className="flex flex-col p-3 bg-gray-100 border border-gray-300 border-l-0 border-r-0 border-b-0 flex-4/5">
        ...
        <div className="p-2 my-2">
          ...
          {options.map((option) => (
            <Option
              ...
              id={option?.id}
              value={option?.value}
              itemOptionsChangeHandler={itemOptionsChangeHandler}
